...
void cookTorrancePrepMaterials(Material** materials)
{
	materials[0] = new LambertianMaterial(blacktex, whitetex);
	materials[1] = new LambertianMaterial(blacktex, redtex);
	materials[2] = new LambertianMaterial(blacktex, greentex);

	materials[3] = new CookTorranceMaterial(blacktex, blacktex, whitetex, 2.485f, 3.433f, 0.368044f, 1.0472f);
	//materials[3] = new PhongMaterial(whitetex, 10.0f);

	materials[4] = new LambertianMaterial(blacktex, whitetex);
}

void renderCookTorrance(float scale, const char* filename, Material** materials)
{
	Image img(400, 400);
	World world;
	SimpleGroup* scene = new SimpleGroup();
	...
	//point light
	world.light.push_back(new PointLight(Point((278)*scale, 529.99f*scale, (279.5f)*scale), RGBColor::rep(150000.0f*scale*scale)));
	world.light.push_back(new PointLight(Point((130)*scale, 200.99f*scale, (0.5f)*scale), RGBColor::rep(50000.0f*scale*scale)));
...
void a_materials() {
    ...
    a7renderCornellbox(0.001f, "a5-5.png", materials);
    a7prepMaterials2(materials);
    a7renderCornellbox(0.001f, "a5-6.png", materials);
    a7prepMaterials3(materials);
    a7renderCornellbox(0.001f, "a5-7.png", materials);
	cookTorrancePrepMaterials(materials);
	renderCookTorrance(0.001f, "a5-11.png", materials);
    delete [] materials;
}
